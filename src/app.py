...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, strategy, and fitness through soccer matches",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop shooting, dribbling, and defensive skills in a team setting",
    ...
    "Math Olympiad": {
        "description": "Solve advanced problems, compete in team challenges, and strengthen analytical thinking",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
        "participants": ["liam@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments, explore scientific concepts, and present findings to the group",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
